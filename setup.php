...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (!preg_match('/^[A-Za-z0-9_]+$/', DB_NAME)) {
            throw new RuntimeException('Invalid database name in the database configuration.');
        }
        ...
        $error = 'Installation failed. Check that MySQL is running in Laragon and verify your database settings.';
    }
}
?>
<!DOCTYPE html>
